...
%
Image = im2double(OImage); %Converting image to double precision
...
%
K = 1;
GImage = K * (Image - lowgv) / (lowgv - uppgv); %Expanding the gray value
...
% 
% 'spillway-dark.tif':
Image1 = imread('Lab1_Images\spillway-dark.tif');
imshow(GammaCorrection(Image1, 2.5, 0.01, 0.98));
%
%
